...
public abstract class FakeApiServiceGenerator {    // class abstraite

    static List<User> generateUsers() {      // FONCTION
        return new ArrayList<>(FAKE_USERS);
    }   // normalement ajouter des utilisateus

    public static List<User> FAKE_USERS = Arrays.asList(                                                           // tableau
    ...
    public static List<User> FAKE_USERS_RANDOM = Arrays.asList(                                       // au hassard
